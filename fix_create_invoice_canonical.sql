-- FINAL CANONICAL RPC: create_invoice using only existing columns
-- This eliminates ALL 42703 column-missing errors permanently
...
BEGIN
  ...
  -- INSERT into ONLY canonical columns that exist
...
-- Verification
SELECT 'Canonical create_invoice function (ALL missing columns fixed):' as info;
