-- FIX TRIGGER SYNTAX - TPC SIGNUP BLOCKER RESOLUTION
-- Execute ini di Supabase SQL Editor untuk memperbaiki syntax error

-- =====================================================
-- STEP 1: DISABLE TRIGGER YANG MENYEBABKAN 500 ERROR
-- =====================================================

-- Syntax yang benar untuk disable trigger
ALTER TABLE auth.users DISABLE TRIGGER on_auth_user_created;

-- Verifikasi trigger sudah disabled
SELECT 
