-- FINAL SQL FIX - TPC SIGNUP NON-BLOCKING TRIGGER
-- Execute ini di Supabase SQL Editor untuk menghilangkan 500 error

-- =====================================================
-- STEP 0: Verifikasi schema public ada
-- =====================================================
SELECT schema_name 
...
-- =====================================================
-- STEP 1: Buat function fail-open (non-blocking)
-- =====================================================
...
-- =====================================================
-- STEP 2: Buat trigger baru yang aman (tidak mengganggu trigger lain)
-- =====================================================
DO $$
BEGIN
  IF NOT EXISTS (
...
-- =====================================================
-- STEP 3: Verifikasi trigger sudah dibuat
-- =====================================================
SELECT
...
-- =====================================================
-- STEP 4: Test signup verification
-- =====================================================
