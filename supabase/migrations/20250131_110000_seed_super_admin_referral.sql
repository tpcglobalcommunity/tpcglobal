...
-- Adds referral_code to invoices table and seeds super admin referral

-- Phase 1: Add referral_code to invoices table
DO $$
BEGIN
...
-- Phase 2: Create referral tracking table (optional but recommended)
...
BEGIN
    ...
    RAISE NOTICE 'Added referral_code column to invoices table';
