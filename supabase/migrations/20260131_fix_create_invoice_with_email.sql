-- FIX create_invoice to include email and restore email functionality
-- This aligns the RPC signature with frontend expectations and enables email sending
...
-- Create canonical function with email parameter matching frontend needs
...
BEGIN
  ...
  -- INSERT with buyer_email included
