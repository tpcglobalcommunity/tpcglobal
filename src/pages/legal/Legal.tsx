          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <PremiumCard>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">
                  {t("legal.page.transparency")}
                </h3>
                
                <p className="text-white/60 text-sm mb-6 leading-relaxed">
                  {t("legal.page.transparencyDesc")}
                </p>
                
                <Link to={getLangPath(lang as any, "/transparency")}>
                  <PremiumButton variant="secondary" size="sm" className="w-full">
                    {t("legal.page.viewTransparency")}
                  </PremiumButton>
                </Link>
              </div>
            </PremiumCard>
            ...
            <PremiumCard>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">
                  {t("legal.page.telegram")}
                </h3>
                
                <p className="text-white/60 text-sm mb-6 leading-relaxed">
                  {t("legal.page.telegramDesc")}
                </p>
