...
const MemberLogin = ({ lang }: MemberLoginProps) => {
  const { t } = useI18n();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.email || !formData.password) {
      setError(tt(t, "member.login.errorTitle", "Login failed"));
      return;
    }
    ...
    try {
      ...
      if (error) {
        let errorMessage = tt(t, "member.login.errorTitle", "Login failed");
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#F0B90B]/10 to-[#C29409]/10 border border-[#F0B90B]/20 mb-6">
              ...
              <span className="text-sm font-medium text-[#F0B90B]">
                {tt(t, "member.login.title", "Member Login")}
              </span>
            </div>
            ...
            <p className="text-white/70 leading-relaxed">
              {tt(t, "member.login.subtitle", "Access the member area securely with your account.")}
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-white mb-2">
                  {tt(t, "member.login.emailLabel", "Email")}
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={tt(t, "member.login.emailPlaceholder", "name@example.com")}
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-white mb-2">
                  {tt(t, "member.login.passwordLabel", "Password")}
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  <input
                    ...
                    placeholder={tt(t, "member.login.passwordPlaceholder", "Enter your password")}
              ...
              >
                {isLoading ? (
                  <>
                    ...
                    {tt(t, "member.login.loading", "Signing in...")}
                  </>
                ) : (
                  tt(t, "member.login.submit", "Sign In")
                )}
              </PremiumButton>
            </form>
          </PremiumCard>
              ...
              <div className="text-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-500/20 border border-amber-500/30 mb-4">
                  ...
                  <span className="text-sm font-medium text-amber-400">
                    {tt(t, "member.login.noticeTitle", "Security Notice")}
                  </span>
                </div>
                ...
                <p className="text-white/60 text-sm leading-relaxed">
                  {tt(t, "member.login.noticeDesc", "Never share your password. TPC will never ask for your credentials outside this site.")}
                </p>
              </div>
            </PremiumCard>
          </div>
