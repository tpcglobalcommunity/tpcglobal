...
export function useI18n() {
  ...
  if (!ctx) {
    // jangan crash putih tak jelas: kasih error jelas di console
    throw new Error("useI18n() must be used within <I18nProvider> (missing provider in main.tsx/App root).");
  }
  return ctx;
}
