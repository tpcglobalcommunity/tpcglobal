...
export const translations: Record<Language, Record<string, TranslationValue>> = {
  en: {
    ...
    "legal.page.description": "At TPC Global, we believe in complete transparency and trust. Our legal framework ensures community safety, compliance with regulations, and clear documentation of all operations.",
    "legal.page.docs": "Documentation",
    "legal.page.docsDesc": "Comprehensive documentation covering our principles, operations, and community guidelines.",
    "legal.page.viewDocs": "View Documentation",
    "legal.page.transparency": "Transparency",
    "legal.page.transparencyDesc": "Real-time transparency reports, wallet allocations, and complete audit trails for community trust.",
    "legal.page.viewTransparency": "View Transparency",
    "legal.page.telegram": "Community",
    "legal.page.telegramDesc": "Join our active community on Telegram for updates, discussions, and direct support.",
    "legal.page.joinTelegram": "Join Telegram",
    "legal.page.footer": "Last updated: January 2026. For questions about our legal framework, please contact our team through official channels.",
    "nav.fund": "Support",
    "fund.badge": "Support",
  ...
  id: {
    ...
    "legal.page.description": "Di TPC Global, kami percaya pada transparansi dan kepercayaan penuh. Kerangka hukum kami memastikan keamanan komunitas, kepatuhan regulasi, dan dokumentasi yang jelas dari semua operasi.",
    "legal.page.docs": "Dokumentasi",
    "legal.page.docsDesc": "Dokumentasi komprehensif yang mencakup prinsip, operasi, dan panduan komunitas kami.",
    "legal.page.viewDocs": "Lihat Dokumentasi",
    "legal.page.transparency": "Transparansi",
    "legal.page.transparencyDesc": "Laporan transparansi real-time, alokasi wallet, dan audit trail lengkap untuk kepercayaan komunitas.",
    "legal.page.viewTransparency": "Lihat Transparansi",
    "legal.page.telegram": "Komunitas",
    "legal.page.telegramDesc": "Bergabung dengan komunitas aktif kami di Telegram untuk update, diskusi, dan dukungan langsung.",
    "legal.page.joinTelegram": "Bergabung Telegram",
    "legal.page.footer": "Terakhir diperbarui: Januari 2026. Untuk pertanyaan tentang kerangka hukum kami, silakan hubungi tim kami melalui saluran resmi.",
    "nav.fund": "Dukungan",
    "fund.badge": "Dukungan",
