...
export const translations: Record<Language, Record<string, TranslationValue>> = {
  en: {
    ...
    "legal.page.cardDocs.title": "Documentation",
    "legal.page.cardDocs.desc": "Comprehensive documentation covering our principles, operations, and community guidelines.",
    "legal.page.cardDocs.cta": "View Documentation",
    "legal.page.cardTransparency.title": "Transparency",
    "legal.page.cardTransparency.desc": "Real-time transparency reports, wallet allocations, and complete audit trails for community trust.",
    "legal.page.cardTransparency.cta": "View Transparency",
    "legal.page.cardTelegram.title": "Join Telegram Community",
    "legal.page.cardTelegram.desc": "Join our active community on Telegram for updates, discussions, and direct support.",
    "legal.page.cardTelegram.cta": "Join Telegram",
    "signin.title": "Built on Transparency & Accountability",
    "signin.subtitle": "Access TPC services with full clarity and community trust.",
    "signin.notice.risk": "Trading involves risk",
    "signin.notice.desc": "TPC provides education and tools — not financial advice or profit guarantees.",
    "signin.card.transparency.title": "Verified Transparency",
    "signin.card.transparency.desc": "Official wallets, allocations, and logs are publicly auditable.",
    "signin.card.transparency.cta": "Open Transparency",
    "signin.card.education.title": "Professional Education",
    "signin.card.education.desc": "Structured learning and a risk-first mindset for professional traders.",
    "signin.button.openTransparency": "Open Transparency",
    "member.login.title": "Member Login",
    "member.login.subtitle": "Access the member area securely with your account.",
    "member.login.emailLabel": "Email",
    "member.login.emailPlaceholder": "name@example.com",
    "member.login.passwordLabel": "Password",
    "member.login.passwordPlaceholder": "Enter your password",
    "member.login.submit": "Sign In",
    "member.login.loading": "Signing in...",
    "member.login.errorTitle": "Login failed",
    "member.login.noticeTitle": "Security Notice",
    "member.login.noticeDesc": "Never share your password. TPC will never ask for your credentials outside this site.",
    "member.login.forgot": "Forgot password?",
    "member.login.createAccount": "Create account",
    "member.dashboard.title": "Member Dashboard",
    "member.dashboard.subtitle": "This area is being prepared.",
    "auth.signin.title": "Sign In",
    "auth.signin.subtitle": "Log in securely to access the member area.",
    "auth.signin.emailLabel": "Email",
    "auth.signin.emailPlaceholder": "name@example.com",
    "auth.signin.passwordLabel": "Password",
    "auth.signin.passwordPlaceholder": "Enter your password",
    "auth.signin.submit": "Sign In",
    "auth.signin.loading": "Signing in...",
    "auth.signin.errorTitle": "Login failed",
    "auth.signin.securityTitle": "Security Notice",
    "auth.signin.securityDesc": "Never share your password. TPC will never ask for your credentials outside this site.",
    ...
    "auth.forgot.successDesc": "If an account exists for this email, a reset link has been sent.",
    "auth.forgot.backToSignin": "Back to Sign In",
    "auth.forgot.errorTitle": "Request failed",
    "auth.forgot.forgot": "Forgot password?",
    ...
    "auth.reset.confirmPasswordPlaceholder": "Re-enter new password",
    "auth.reset.submit": "Update Password",
    "auth.reset.loading": "Updating...",
    "auth.reset.successTitle": "Password updated",
    "auth.reset.successDesc": "Your password has been updated. Please sign in again.",
    "auth.reset.invalidTitle": "Link invalid or expired",
    "auth.reset.invalidDesc": "Please request a new password reset link.",
    "auth.reset.requestNew": "Request new link",
    "auth.reset.errorTitle": "Update failed",
  ...
  id: {
    ...
    "legal.page.cardDocs.title": "Dokumentasi",
    "legal.page.cardDocs.desc": "Dokumentasi lengkap tentang prinsip, operasional, dan panduan komunitas.",
    "legal.page.cardDocs.cta": "Lihat Dokumentasi",
    "legal.page.cardTransparency.title": "Transparansi",
    "legal.page.cardTransparency.desc": "Laporan transparansi real-time, alokasi wallet, dan jejak audit lengkap untuk membangun kepercayaan komunitas.",
    "legal.page.cardTransparency.cta": "Lihat Transparansi",
    "legal.page.cardTelegram.title": "Gabung Komunitas Telegram",
    "legal.page.cardTelegram.desc": "Gabung komunitas Telegram kita untuk update, diskusi, dan dukungan langsung.",
    "legal.page.cardTelegram.cta": "Gabung Telegram",
    "signin.title": "Dibangun dengan transparansi & akuntabilitas",
    "signin.subtitle": "Akses layanan TPC dengan kejelasan penuh dan kepercayaan komunitas.",
    "signin.notice.risk": "Trading memiliki risiko",
    "signin.notice.desc": "TPC menyediakan edukasi dan tools — bukan nasihat keuangan atau jaminan profit.",
    "signin.card.transparency.title": "Transparansi Terverifikasi",
    "signin.card.transparency.desc": "Wallet resmi, alokasi, dan log dapat dilihat serta diaudit publik.",
    "signin.card.transparency.cta": "Buka Transparansi",
    "signin.card.education.title": "Edukasi Profesional",
    "signin.card.education.desc": "Pembelajaran terstruktur dan mindset risk-first untuk trader profesional.",
    "signin.button.openTransparency": "Buka Transparansi",
    "member.login.title": "Login Member",
    "member.login.subtitle": "Masuk ke member area dengan aman menggunakan akun kita.",
    "member.login.emailLabel": "Email",
    "member.login.emailPlaceholder": "nama@email.com",
    "member.login.passwordLabel": "Password",
    "member.login.passwordPlaceholder": "Masukkan password",
    "member.login.submit": "Masuk",
    "member.login.loading": "Sedang masuk...",
    "member.login.errorTitle": "Login gagal",
    "member.login.noticeTitle": "Pemberitahuan Keamanan",
    "member.login.noticeDesc": "Jangan bagikan password. TPC tidak akan pernah meminta kredensial kita di luar situs ini.",
    "member.login.forgot": "Lupa password?",
    "member.login.createAccount": "Buat akun",
    "member.dashboard.title": "Dashboard Member",
    "member.dashboard.subtitle": "Area ini sedang disiapkan.",
    "auth.signin.title": "Masuk",
    "auth.signin.subtitle": "Masuk dengan aman untuk mengakses member area.",
    "auth.signin.emailLabel": "Email",
    "auth.signin.emailPlaceholder": "nama@email.com",
    "auth.signin.passwordLabel": "Password",
    "auth.signin.passwordPlaceholder": "Masukkan password",
    "auth.signin.submit": "Masuk",
    "auth.signin.loading": "Sedang masuk...",
    "auth.signin.errorTitle": "Login gagal",
    "auth.signin.securityTitle": "Pemberitahuan Keamanan",
    "auth.signin.securityDesc": "Jangan bagikan password. TPC tidak akan pernah meminta kredensial kita di luar situs ini.",
    "auth.signin.showPassword": "Tampilkan password",
    "auth.signin.hidePassword": "Sembunyikan password",
    "auth.forgot.title": "Lupa Password",
    "auth.forgot.subtitle": "Masukkan email, kita kirim tautan reset password.",
    "auth.forgot.emailLabel": "Email",
    "auth.forgot.emailPlaceholder": "nama@email.com",
    "auth.forgot.submit": "Kirim Tautan Reset",
    "auth.forgot.loading": "Mengirim...",
    "auth.forgot.successTitle": "Cek email kita",
    "auth.forgot.successDesc": "Jika email terdaftar, tautan reset sudah dikirim.",
    "auth.forgot.backToSignin": "Kembali ke Login",
    "auth.forgot.errorTitle": "Permintaan gagal",
    "auth.forgot.forgot": "Lupa password?",
    "auth.reset.title": "Reset Password",
    "auth.reset.subtitle": "Buat password baru untuk akun kita.",
    "auth.reset.newPasswordLabel": "Password baru",
    "auth.reset.newPasswordPlaceholder": "Masukkan password baru",
    "auth.reset.confirmPasswordLabel": "Konfirmasi password",
    "auth.reset.confirmPasswordPlaceholder": "Masukkan ulang password baru",
    "auth.reset.submit": "Perbarui Password",
    "auth.reset.loading": "Memperbarui...",
    "auth.reset.successTitle": "Password diperbarui",
    "auth.reset.successDesc": "Password berhasil diperbarui. Silakan login kembali.",
    "auth.reset.invalidTitle": "Tautan tidak valid atau kedaluwarsa",
    "auth.reset.invalidDesc": "Silakan minta tautan reset password yang baru.",
    "auth.reset.requestNew": "Minta tautan baru",
    "auth.reset.errorTitle": "Gagal memperbarui",
    "auth.reset.passwordTooShort": "Password minimal 8 karakter.",
    "auth.reset.passwordMismatch": "Password tidak sama.",
    "nav.fund": "Dukungan",
    "fund.badge": "Dukungan",
