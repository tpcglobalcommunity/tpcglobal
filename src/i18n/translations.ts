...
export const translations: Record<Language, Record<string, TranslationValue>> = {
  en: {
    ...
    "legal.badge": "Legal",
    "legal.title": "Legal & Risk Disclaimer",
    "legal.subtitle": "Important information to understand before using TPC.",
    "legal.noticeTitle": "Trading involves risk",
    "legal.noticeBody": "TPC provides education and tools. Nothing on this platform is financial advice or a guarantee of profit. Always do your own research and manage risk responsibly.",
    "legal.cta.docs": "Documentation",
    "legal.cta.transparency": "Transparency",
    "legal.cta.community": "Join Telegram Community",
    "nav.fund": "Support",
    "fund.badge": "Support",
    ...
    "placeholder.notAvailable.backToHome": "Back to Home",
    "auth.signup.badge": "Create Account",
    ...
    "auth.signup.step1": "Account",
    "auth.signup.step2": "Verify",
    "auth.signup.fullName.label": "Full Name",
    ...
    "auth.signup.password.placeholder": "Create a strong password",
    "auth.signup.passwordConfirm.label": "Confirm Password",
    "auth.signup.passwordConfirm.placeholder": "Confirm your password",
    "auth.signup.referral.label": "Referral Code (Optional)",
    "auth.signup.referral.placeholder": "Enter referral code",
    "auth.signup.referral.helper": "Get benefits from community referrals",
    "auth.signup.terms.label": "I accept the",
    "auth.signup.terms.legal": "Terms of Service",
    "auth.signup.terms.privacy": "and Privacy Policy",
    "auth.signup.submit": "Create Account",
    "auth.signup.loading": "Creating Account...",
    "auth.signup.haveAccount": "Already have an account?",
    "auth.signup.signIn": "Sign In",
    "auth.signup.success.title": "Check Your Email",
    "auth.signup.success.body": "We've sent a verification link to your email address. Click the link to complete your registration.",
    "auth.signup.success.cta": "Back to Sign In",
    "auth.signup.errors.required": "This field is required",
    "auth.signup.errors.email": "Please enter a valid email address",
    "auth.signup.errors.passwordMin": "Password must be at least 8 characters",
    "auth.signup.errors.passwordNumber": "Password must contain at least 1 number",
  ...
  id: {
    ...
    "footer.brand": "Trader Professional Community",
    "legal.badge": "Legal",
    "legal.title": "Legal & Disclaimer Risiko",
    "legal.subtitle": "Informasi penting sebelum menggunakan TPC.",
    "legal.noticeTitle": "Trading memiliki risiko",
    "legal.noticeBody": "TPC menyediakan edukasi dan tools. Tidak ada konten di platform ini yang merupakan nasihat keuangan atau jaminan profit. Lakukan riset sendiri dan kelola risiko dengan bijak.",
    "legal.cta.docs": "Dokumentasi",
    "legal.cta.transparency": "Transparansi",
    "legal.cta.community": "Gabung Komunitas Telegram",
    "nav.fund": "Dukungan",
    "fund.badge": "Dukungan",
    ...
    "placeholder.notAvailable.backToHome": "Kembali ke Beranda",
    "auth.signup.badge": "Buat Akun",
    ...
    "auth.signup.step1": "Akun",
    "auth.signup.step2": "Verifikasi",
    "auth.signup.fullName.label": "Nama Lengkap",
    "auth.signup.fullName.placeholder": "Masukkan nama lengkap Anda",
    "auth.signup.email.label": "Alamat Email",
    "auth.signup.email.placeholder": "Masukkan alamat email Anda",
    "auth.signup.password.label": "Kata Sandi",
    "auth.signup.password.placeholder": "Buat kata sandi yang kuat",
    "auth.signup.passwordConfirm.label": "Konfirmasi Kata Sandi",
    "auth.signup.passwordConfirm.placeholder": "Konfirmasi kata sandi Anda",
    "auth.signup.referral.label": "Kode Referral (Opsional)",
    "auth.signup.referral.placeholder": "Masukkan kode referral",
    "auth.signup.referral.helper": "Dapatkan manfaat dari referral komunitas",
    "auth.signup.terms.label": "Saya menerima",
    "auth.signup.terms.legal": "Syarat & Ketentuan",
    "auth.signup.terms.privacy": "dan Kebijakan Privasi",
    ...
    "auth.signup.success.title": "Periksa Email Anda",
    "auth.signup.success.body": "Kami telah mengirim tautan verifikasi ke alamat email Anda. Klik tautan untuk menyelesaikan pendaftaran.",
    "auth.signup.success.cta": "Kembali ke Masuk",
    "auth.signup.errors.required": "Field ini wajib diisi",
    "auth.signup.errors.email": "Masukkan alamat email yang valid",
    "auth.signup.errors.passwordMin": "Kata sandi minimal 8 karakter",
    "auth.signup.errors.passwordNumber": "Kata sandi harus mengandung minimal 1 angka",
