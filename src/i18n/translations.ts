  ...
  en: {
      ...
      items: {
        ...
        membership: {
          ...
          q4: {
            ...
            a: 'TPC uses role-based access:\n\nâ€¢ Member: Standard access to community features and content\nâ€¢ Moderator: Trusted members who help maintain community standards\nâ€¢ Admin: TPC team members responsible for operations and governance\n\nRoles ensure proper access control and transparent accountability.',
          },
        },
        security: {
          q1: {
        ...
        transparency: {
          ...
          q2: {
            ...
            a: 'TPC operates on radical transparency. We publish:\n\nâ€¢ Treasury wallet addresses and balances\nâ€¢ Governance proposals and voting results\nâ€¢ Operational updates and milestone progress\nâ€¢ Financial operations (buyback, burn, allocations)\n\nTransparency builds trust and accountability.',
          },
          q3: {
    ...
    auth: {
      ...
      maintenance: {
        ...
        title: "We're upgrading TPC",
        subtitle: "We're applying updates to improve stability and security. Admin access remains available.",
        notice: "Please check back soon. Thank you for your patience.",
        ctaTitle: "Need updates right now?",
        ctaDesc: "Join the official community channel for announcements and support.",
        joinTelegram: "Open Telegram Channel",
        backHome: "Back to Home",
        footnote: "Security-first: we never guarantee profits. Educational and community-focused."
      },
      errors: {
    ...
    member: {
      ...
      security: {
        ...
        status: {
          ...
          desc: 'Your account is protected with education-first privacy practices. We never share your data.',
        ...
        actions: {
          ...
          confirmDescDevice: 'You will be signed out from this device. You can sign in again anytime.',
          confirmDescAll: 'This will sign you out from ALL devices and sessions. You will need to sign in again on each device.',
          cancel: 'Cancel',
          confirm: 'Sign Out',
        },
        activity: {
      ...
      profile: {
        ...
        role: 'Role',
        verified: 'Verification Status',
        canInvite: 'Invite Permissions',
        referralCode: 'Referral Code',
        referredBy: 'Referred By',
        usernameHelp: '3-20 characters, lowercase letters, numbers, underscore only. Cannot start or end with underscore.',
        ...
        directory: {
          ...
          bio: 'Bio',
          country: 'Country',
          privacyNote: 'Your profile is private by default. Enable directory visibility to let other members discover and connect with you. Only safe information will be shown.',
          save: 'Save Settings',
          saved: 'Directory settings updated',
          charLeft: 'characters left',
        },
      },
      referrals: {
        title: 'Referral Analytics',
        subtitle: 'Track your invites and grow the TPC community',
        noticeTitle: 'Invite-Only Platform',
        noticeDesc: 'Referrals do not guarantee rewards or profit. Share your code responsibly with people you trust.',
        stats: {
          total: 'Total Referrals',
          last7: 'Last 7 Days',
          last30: 'Last 30 Days',
          canInvite: 'Invite Status',
          inviteActive: 'Active',
        ...
        code: {
          ...
          copy: 'Copy',
          copied: 'Copied',
          shareSignup: 'Signup Link',
          shareVerify: 'Verify Link',
          copyLink: 'Copy Link',
        },
        list: {
          title: 'Recent Invites',
          emptyTitle: 'No Invites Yet',
          emptyDesc: 'Share your referral code to invite members to the TPC community.',
          joined: 'Joined',
          verified: 'Verified',
        },
      },
      directory: {
        ...
        subtitle: 'Browse and connect with verified TPC community members',
        searchPlaceholder: 'Search by name or username...',
        emptyTitle: 'No Members Found',
        emptyDesc: 'No members match your search. Try a different query.',
        viewProfile: 'View',
        memberSince: 'Joined',
        verified: 'Verified',
        role: 'Role',
    ...
    public: {
      profile: {
        ...
        notAvailableDesc: 'This profile is private or does not exist. Members can choose to show their profiles in the directory.',
        verifyCta: 'Verify Membership',
    ...
    marketplace: {
      title: 'TPC Marketplace',
      subtitle: 'Discover trusted vendors and service providers from the TPC community',
      ...
      emptyDesc: 'There are no approved vendors in this category yet.',
      visitWebsite: 'Visit Website',
      contactTelegram: 'Contact on Telegram',
      disclaimer: 'Listings are informational only. TPC does not endorse or guarantee any vendor services or results.',
      footerDisclaimer: 'Vendors are independent. TPC does not guarantee results or returns.',
      applyAsVendor: 'Apply as Vendor',
    },
    vendor: {
      apply: {
        title: 'Apply as Vendor',
        subtitle: 'List your business in the TPC Marketplace and connect with our community',
        disclaimer: 'Listing is informational only. No guarantees, endorsements, or financial promises are made.',
        brandName: 'Brand Name',
        category: 'Category',
        descriptionEn: 'Description (English)',
        descriptionId: 'Description (Indonesian)',
        contactInfo: 'Contact Information',
        contactInfoDesc: 'Provide at least one contact method for potential customers to reach you.',
        website: 'Website',
        telegram: 'Telegram',
        email: 'Email',
    ...
    admin: {
      vendors: {
        ...
        subtitle: 'Review and manage vendor applications for the marketplace',
        filter: {
          all: 'All',
          pending: 'Pending',
          approved: 'Approved',
        ...
        empty: 'No vendor applications found',
        approve: 'Approve',
        reject: 'Reject',
      ...
      announcements: {
        ...
        filterDraft: 'Draft',
        actionsEdit: 'Edit',
        actionsPublish: 'Publish',
        actionsUnpublish: 'Unpublish',
        actionsPin: 'Pin',
        actionsUnpin: 'Unpin',
      ...
      control: {
        ...
        subtitle: 'Comprehensive user management and oversight panel',
        noticeTitle: 'Enterprise Security',
        noticeBody: 'All administrative actions are logged and auditable. Exercise caution when modifying user permissions.',
        tabs: {
          users: 'Users',
          vendors: 'Vendors',
          audit: 'Audit Log',
        ...
        filters: {
          searchPlaceholder: 'Search by username, name, or referral code...',
          role: 'Role',
          verified: 'Verified',
        ...
        modal: {
          ...
          warningRole: 'Warning: Only super admins can assign super admin role.',
          warningLastAdmin: 'Warning: Cannot demote the last super admin.',
          confirmAction: 'Please confirm this action by typing CONFIRM below:',
        },
        toasts: {
          updated: 'User updated successfully',
          failed: 'Failed to update user',
          roleChanged: 'User role updated successfully',
          verifiedChanged: 'User verification status updated',
          inviteChanged: 'User invite permission updated',
        },
        vendors: {
          ...
          status: 'Status',
          reviewed: 'Reviewed',
          confirmApprove: 'Are you sure you want to approve this vendor application?',
          confirmReject: 'Are you sure you want to reject this vendor application?',
        },
        audit: {
    ...
    editor: {
      announcements: {
        titleNew: 'Create Announcement',
        titleEdit: 'Edit Announcement',
        fieldTitleEn: 'Title (English)',
        fieldTitleId: 'Title (Indonesian)',
        fieldBodyEn: 'Content (English)',
        fieldBodyId: 'Content (Indonesian)',
        fieldCategory: 'Category',
        fieldPinned: 'Pin this announcement',
        fieldPublished: 'Publish immediately',
  ...
  id: {
    ...
    transparency: {
      ...
      policy: {
        ...
        youtube: [
          '50% â€” Buyback Token',
          '20% â€” Penambahan Pool Likuiditas',
      ...
      items: {
        ...
        membership: {
          ...
          q4: {
            ...
            a: 'TPC menggunakan akses berbasis peran:\n\nâ€¢ Member: Akses standar ke fitur dan konten komunitas\nâ€¢ Moderator: Anggota terpercaya yang membantu menjaga standar komunitas\nâ€¢ Admin: Anggota tim TPC yang bertanggung jawab atas operasi dan tata kelola\n\nPeran memastikan kontrol akses yang tepat dan akuntabilitas yang transparan.',
          },
        },
        security: {
          q1: {
        ...
        transparency: {
          ...
          q2: {
            ...
            a: 'TPC beroperasi dengan transparansi radikal. Kami mempublikasikan:\n\nâ€¢ Alamat wallet treasury dan saldo\nâ€¢ Proposal tata kelola dan hasil voting\nâ€¢ Update operasional dan progress milestone\nâ€¢ Operasi keuangan (buyback, burn, alokasi)\n\nTransparansi membangun kepercayaan dan akuntabilitas.',
          },
          q3: {
    ...
    auth: {
      ...
      maintenance: {
        ...
        title: "Kita Sedang Meningkatkan TPC",
        subtitle: "Kita sedang melakukan pembaruan untuk meningkatkan stabilitas dan keamanan. Akses admin tetap tersedia.",
        notice: "Silakan periksa kembali nanti. Terima kasih atas kesabaran Anda.",
        ctaTitle: "Butuh pembaruan sekarang?",
        ctaDesc: "Bergabung dengan saluran komunitas resmi untuk pengumuman dan dukungan.",
        joinTelegram: "Buka Saluran Telegram",
        backHome: "Kembali ke Beranda",
        footnote: "Keamanan prioritas: kami tidak pernah menjamin keuntungan. Berfokus pada edukasi dan komunitas."
      },
      completeProfile: {
        title: 'Lengkapi Profil Anda',
