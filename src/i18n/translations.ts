  ...
  en: {
    ...
    auth: {
      ...
      signup: {
        ...
        referralRequired: "Invitation code is required",
        referral: "Invitation Code",
        referralPlaceholder: "TPC-XXXXXX",
        username: "Username",
        usernamePlaceholder: "johndoe",
        usernameRequired: "Username is required",
        usernameRules: "3–20 chars: lowercase letters, numbers, underscore.",
        email: "Email",
        ...
        checkEmailDesc: "Please check your email (including spam folder) to verify your account. After verification, you can login.",
        sentTo: "Verification sent to:",
        goToSignIn: "Go to Sign In",
        alreadyVerified: "I already verified",
        inviteOnly: "By invitation only. Referral required.",
        progressLabel: "Complete your details",
        passwordMatched: "Matched",
        passwordNotMatched: "Does not match",
        trustChip1: "Invitation-only",
        trustChip2: "Education-first",
        trustChip3: "No profit promises",
        footerLine1: "By joining, you agree to our",
        footerTerms: "Terms & Privacy",
        footerLine2: ".",
        footerDisclaimer: "Trading involves risk. This is not financial advice.",
      },
      completeProfile: {
  ...
  id: {
    ...
    auth: {
      ...
      signup: {
        ...
        referralChecking: "Memeriksa kode undangan...",
        referralValid: "Undangan terverifikasi",
        referralInvalid: "Kode undangan tidak valid",
        referralError: "Gagal memvalidasi kode undangan",
        backToHome: "Kembali ke Beranda",
        alreadyHaveAccount: "Sudah punya akun?",
        signIn: "Masuk",
        createAccount: "Buat Akun",
        title: "Buat akun TPC Anda",
        subtitle: "Akses hanya undangan. Masukkan kode Anda untuk melanjutkan.",
        referralRequired: "Kode undangan diperlukan",
        referral: "Kode Undangan",
        referralPlaceholder: "TPC-XXXXXX",
        username: "Nama Pengguna",
        usernamePlaceholder: "johndoe",
        usernameRequired: "Nama pengguna diperlukan",
        usernameRules: "3–20 karakter: huruf kecil, angka, underscore.",
        email: "Email",
        emailPlaceholder: "email@example.com",
        ...
        completeForm: "Silakan lengkapi formulir",
        creating: "Membuat...",
        errorGeneric: "Gagal membuat akun",
        successTitle: "Akun berhasil dibuat",
        checkEmailDesc: "Silakan periksa email Anda (termasuk folder spam) untuk memverifikasi akun. Setelah verifikasi, Anda bisa login.",
        sentTo: "Verifikasi dikirim ke:",
        goToSignIn: "Pergi ke Masuk",
        alreadyVerified: "Saya sudah verifikasi",
        inviteOnly: "Hanya undangan. Referral diperlukan.",
        progressLabel: "Lengkapi detail Anda",
        passwordMatched: "Cocok",
        passwordNotMatched: "Tidak cocok",
        trustChip1: "Hanya undangan",
        trustChip2: "Pendidikan dulu",
        trustChip3: "Tidak ada janji profit",
        footerLine1: "Dengan bergabung, Anda setuju dengan",
        footerTerms: "Syarat & Privasi",
        footerLine2: ".",
        footerDisclaimer: "Trading memiliki risiko. Ini bukan saran finansial.",
      },
      maintenance: {
    ...
    member: {
      ...
      security: {
        ...
        subtitle: 'Kelola keamanan akun dan pantau aktivitas Anda',
        status: {
          title: 'Status Keamanan',
          desc: 'Akun Anda dilindungi dengan praktik privasi yang mengutamakan edukasi. Kami tidak pernah membagikan data Anda.',
          verified: 'Status Verifikasi',
          role: 'Peran Akun',
          invitePermission: 'Izin Undangan',
        },
        session: {
          title: 'Sesi Aktif',
        ...
        actions: {
          ...
          confirmDescDevice: 'Anda akan keluar dari perangkat ini. Anda dapat masuk kembali kapan saja.',
          confirmDescAll: 'Ini akan mengeluarkan Anda dari SEMUA perangkat dan sesi. Anda perlu masuk lagi di setiap perangkat.',
          cancel: 'Batal',
          confirm: 'Keluar',
        },
        activity: {
          ...
          emptyDesc: 'Aktivitas keamanan terbaru Anda akan muncul di sini.',
          eventSignIn: 'Masuk',
          eventSignOut: 'Keluar',
          eventPasswordReset: 'Reset Kata Sandi',
          eventPasswordChange: 'Kata Sandi Diubah',
          eventProfileUpdate: 'Profil Diperbarui',
          networkProtected: 'Jaringan: Dilindungi',
        },
      },
      profile: {
        ...
        role: 'Peran',
        verified: 'Status Verifikasi',
        canInvite: 'Izin Undangan',
        referralCode: 'Kode Referral',
        referredBy: 'Direferensikan Oleh',
        usernameHelp: '3-20 karakter, huruf kecil, angka, garis bawah saja. Tidak boleh diawali atau diakhiri dengan garis bawah.',
        usernameInvalid: 'Format nama pengguna tidak valid',
        usernameTaken: 'Nama pengguna sudah digunakan',
        fileTooLarge: 'File terlalu besar. Ukuran maksimum adalah 2MB',
        fileTypeInvalid: 'Tipe file tidak valid. Harap unggah gambar PNG, JPEG, atau WebP saja',
        genericError: 'Terjadi kesalahan. Silakan coba lagi.',
        directory: {
          title: 'Pengaturan Direktori',
          toggle: 'Tampilkan di Direktori Anggota',
          bio: 'Bio',
          country: 'Negara',
          privacyNote: 'Profil Anda bersifat pribadi secara default. Aktifkan visibilitas direktori agar anggota lain dapat menemukan dan terhubung dengan Anda. Hanya informasi aman yang akan ditampilkan.',
          save: 'Simpan Pengaturan',
          saved: 'Pengaturan direktori diperbarui',
          charLeft: 'karakter tersisa',
        },
      },
      referrals: {
        title: 'Analitik Referral',
        subtitle: 'Lacak undangan Anda dan kembangkan komunitas TPC',
        noticeTitle: 'Platform Undangan Saja',
        noticeDesc: 'Referral tidak menjamin reward atau keuntungan. Bagikan kode Anda secara bertanggung jawab dengan orang yang Anda percaya.',
        stats: {
          total: 'Total Referral',
          last7: '7 Hari Terakhir',
          last30: '30 Hari Terakhir',
          canInvite: 'Status Undangan',
          inviteActive: 'Aktif',
          inviteRevoked: 'Dicabut',
        },
        code: {
          title: 'Kode Referral Anda',
          copy: 'Salin',
          copied: 'Tersalin',
          shareSignup: 'Link Pendaftaran',
          shareVerify: 'Link Verifikasi',
          copyLink: 'Salin Link',
        },
        list: {
          title: 'Undangan Terbaru',
          emptyTitle: 'Belum Ada Undangan',
          emptyDesc: 'Bagikan kode referral Anda untuk mengundang anggota ke komunitas TPC.',
          joined: 'Bergabung',
      ...
      directory: {
        ...
        subtitle: 'Jelajahi dan terhubung dengan anggota komunitas TPC yang terverifikasi',
        searchPlaceholder: 'Cari berdasarkan nama atau username...',
        emptyTitle: 'Tidak Ada Anggota Ditemukan',
        emptyDesc: 'Tidak ada anggota yang cocok dengan pencarian Anda. Coba kueri yang berbeda.',
        viewProfile: 'Lihat',
    ...
    public: {
      profile: {
        title: 'Profil Publik',
        notAvailableTitle: 'Profil Tidak Tersedia',
        notAvailableDesc: 'Profil ini bersifat pribadi atau tidak ada. Anggota dapat memilih untuk menampilkan profil mereka di direktori.',
        verifyCta: 'Verifikasi Keanggotaan',
        joinCta: 'Bergabung dengan Komunitas',
    ...
    marketplace: {
      ...
      emptyTitle: 'Tidak Ada Vendor',
      emptyDesc: 'Belum ada vendor yang disetujui dalam kategori ini.',
      visitWebsite: 'Kunjungi Website',
      contactTelegram: 'Hubungi di Telegram',
      disclaimer: 'Daftar vendor bersifat informasi saja. TPC tidak mendukung atau menjamin layanan atau hasil vendor apapun.',
      footerDisclaimer: 'Vendor adalah independen. TPC tidak menjamin hasil atau keuntungan.',
    ...
    vendor: {
      apply: {
        ...
        disclaimer: 'Daftar vendor bersifat informasi saja. Tidak ada jaminan, dukungan, atau janji finansial yang dibuat.',
        brandName: 'Nama Brand',
        category: 'Kategori',
        descriptionEn: 'Deskripsi (Bahasa Inggris)',
        descriptionId: 'Deskripsi (Bahasa Indonesia)',
        contactInfo: 'Informasi Kontak',
        contactInfoDesc: 'Berikan setidaknya satu metode kontak agar calon pelanggan dapat menghubungi Anda.',
        website: 'Website',
        telegram: 'Telegram',
        email: 'Email',
    ...
    admin: {
      vendors: {
        title: 'Kelola Vendor',
        subtitle: 'Review dan kelola aplikasi vendor untuk marketplace',
        filter: {
          all: 'Semua',
          pending: 'Menunggu',
          approved: 'Disetujui',
        ...
        empty: 'Tidak ada aplikasi vendor ditemukan',
        approve: 'Setujui',
        reject: 'Tolak',
        confirmTitle: 'Konfirmasi Aksi',
        confirmDesc: 'Apakah Anda yakin ingin melakukan aksi ini?',
      },
      authLogs: {
      ...
      announcements: {
        ...
        filterDraft: 'Draft',
        actionsEdit: 'Edit',
        actionsPublish: 'Publikasikan',
        actionsUnpublish: 'Batalkan Publikasi',
        actionsPin: 'Pin',
        actionsUnpin: 'Unpin',
        actionsDelete: 'Hapus',
        confirmDelete: 'Apakah Anda yakin ingin menghapus pengumuman ini? Tindakan ini tidak dapat dibatalkan.',
      },
      control: {
        title: 'Pusat Kontrol Admin',
        subtitle: 'Panel manajemen dan pengawasan pengguna komprehensif',
        noticeTitle: 'Keamanan Enterprise',
        noticeBody: 'Semua tindakan administratif dicatat dan dapat diaudit. Berhati-hatilah saat memodifikasi izin pengguna.',
        tabs: {
          users: 'Pengguna',
          vendors: 'Vendor',
          audit: 'Log Audit',
        ...
        filters: {
          searchPlaceholder: 'Cari berdasarkan username, nama, atau kode referral...',
          role: 'Peran',
          verified: 'Terverifikasi',
          canInvite: 'Dapat Mengundang',
          status: 'Status',
          all: 'Semua',
          member: 'Anggota',
          moderator: 'Moderator',
        ...
        user: {
          ...
          canInvite: 'Dapat Mengundang',
          referral: 'Referral',
          joined: 'Anggota Sejak',
          email: 'Email',
          country: 'Negara',
          directory: 'Tampilkan di Direktori',
          vendor: 'Status Vendor',
        },
        modal: {
          title: 'Kelola Pengguna',
          reasonLabel: 'Alasan (Opsional)',
          reasonPlaceholder: 'Masukkan alasan untuk tindakan ini...',
          confirmLabel: 'Ketik CONFIRM untuk melanjutkan',
          confirmPlaceholder: 'CONFIRM',
          warningRole: 'Peringatan: Hanya super admin yang dapat menetapkan peran super admin.',
          warningLastAdmin: 'Peringatan: Tidak dapat menurunkan pangkat super admin terakhir.',
          confirmAction: 'Konfirmasi tindakan ini dengan mengetik CONFIRM di bawah:',
        },
        toasts: {
          updated: 'Pengguna berhasil diperbarui',
          failed: 'Gagal memperbarui pengguna',
          roleChanged: 'Peran pengguna berhasil diperbarui',
          verifiedChanged: 'Status verifikasi pengguna diperbarui',
          inviteChanged: 'Izin undangan pengguna diperbarui',
        },
        vendors: {
          title: 'Aplikasi Vendor',
          empty: 'Tidak ada aplikasi vendor ditemukan',
          brand: 'Nama Brand',
          category: 'Kategori',
          website: 'Website',
          ...
          status: 'Status',
          reviewed: 'Direview',
          confirmApprove: 'Apakah Anda yakin ingin menyetujui aplikasi vendor ini?',
          confirmReject: 'Apakah Anda yakin ingin menolak aplikasi vendor ini?',
        },
        audit: {
    ...
    editor: {
      announcements: {
        titleNew: 'Buat Pengumuman',
        titleEdit: 'Edit Pengumuman',
        fieldTitleEn: 'Judul (Inggris)',
        fieldTitleId: 'Judul (Indonesia)',
        fieldBodyEn: 'Konten (Inggris)',
        fieldBodyId: 'Konten (Indonesia)',
        fieldCategory: 'Kategori',
        fieldPinned: 'Pin pengumuman ini',
        fieldPublished: 'Publikasikan segera',
        save: 'Simpan Pengumuman',
        saving: 'Menyimpan...',
