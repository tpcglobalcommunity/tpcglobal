  ...
  en: {
    ...
    auth: {
      ...
      signup: {
        ...
        usernameRules: 'Username must be 3+ characters, only lowercase letters, numbers, dots, and underscores',
  ...
  id: {
    ...
    auth: {
      ...
      signup: {
        ...
        usernamePlaceholder: 'johndoe',
        usernameRules: 'Nama pengguna minimal 3 karakter, hanya huruf kecil, angka, titik, dan garis bawah',
